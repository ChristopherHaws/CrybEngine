...
ceInt main( ceInt argc, char *argv[] )
{
	...
	while( pInputDevice->Update() && !pKeyboard->KeyPressed( CEK_ESCAPE ) )
	{
		...
		/*pRenderDevice->SetLookAt(	ceVector3( 0.0f, 0.0f, 0.0f ),
									ceVector3( 0.0f, 0.0f, 0.0f ),
									ceVector3( 0.0f, 1.0f, 0.0f ) );
		pRenderDevice->DrawTriangle(	ceVector3( 0.0f, 0.0f, -5.0f ),
										ceVector3( 0.0f, 1.0f, 0.0f ),
										ceVector3( 1.0f, 0.0f, 0.0f ) );*/
